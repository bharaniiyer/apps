    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        festbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent fest = new Intent(MainActivity.this, FestActivity.class);
                startActivity(fest);
            }
        });
        ...
        soonbt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent soon = new Intent(MainActivity.this, ProfileActivity.class);
                startActivity(soon);
            }
        });
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                progressDialog.dismiss();
               // Intent intent = new Intent (MainActivity.this,info.androidhive.expandablelistview.MainActivity.class);
